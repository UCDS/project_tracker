...
<!--	<select name="search_district" id="search_district" class="form-control" style="width:150px">
		...
		<input type="text" class="form-control" placeholder="Division Name" id="search_division" name="search_division" 
	...
	<div class="col-md-12 "><strong>
      <?php if($this->input->post('search_division_id')) echo "Division id : ".$divisions[0]->division_id; ?>
	<?php if($this->input->post('search_division')) echo "Division name starting with : ".$this->input->post('search_division'); ?>
