  ...
  <option value="Assistant Executive Engineer" <?php echo set_select('user_type', 'assistant'); ?> >Assistant Executive Engineer </option>
       ...
       <!--  <label for="users" class="col-md-4" >User Type</label>
		<div  class="col-md-8">
		<select name="users" id="search_user_type" class="form-control" >
		 <option value="">--SELECT--</option>
		<?php foreach($users as $user_type){
...
<div class="form-group">
  ...
  <option value="Assistant Executive Engineer" <?php echo set_select('user_type', 'assistant'); ?> >Assistant Executive Engineer </option>
	...
	<?php if($this->input->post('search_username')) echo "User name  : ".$this->input->post('search_username'); ?>
	</strong>
	</div>	
