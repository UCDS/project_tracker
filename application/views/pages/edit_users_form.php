...
<h3><?php if(isset($msg)) echo $msg;?></h3>	
	<div class="col-md-12">
	<?php echo form_open('masters/edit/users',array('role'=>'form','class'=>'form-inline','name'=>'search_users'));?>
	<h3> Search Users </h3>
	...
	<?php echo form_open('masters/edit/users',array('role'=>'form')); ?>
		...
		<?php foreach($user_type as $u){
			echo "<option value='$u->user_type_id'";
			if(isset($users) && $users[0]->user_type_id==$u->user_type_id)
				echo " SELECTED ";
			echo ">$u->user_type</option>";
		}
		?>
		</select>
	...
	<div class="form_group">
		...
		<input type="radio" name="gender" id="male" value="M" <?php if($users[0]->gender=='M' )echo "checked"; ?> />Male 
		</label>
		<label for="female" class="radio-inline"> 
		<input type="radio" id="female" name="gender"  value="F" <?php if($users[0]->gender=='F' )echo "checked"; ?> /> Female
...
<div class="form-group">
	...
	<thead>
	<th>S.No</th><th>User Type </th><th>User Name</th><th>Password</th><th>First Name</th><th>Last Name</th>
